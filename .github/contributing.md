# Contributing to oauth-client

First and foremost, thank you! We appreciate that you want to contribute to oauth-client, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for oauth-client**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for oauth-client:

- star the [project](https://github.com/Pterobyte/oauth-client)
- tweet your support for oauth-client
...
- **version**: (required) please note the version of oauth-client are you using
...
The original poster or the maintainers of oauth-client may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/oauth-client
